...
Set 1\t{schedule[0][0]}x5\t{schedule[1][0]}x3\t{schedule[2][0]}x5\t{schedule[3][0]}x5
Set 2\t{schedule[0][1]}x5\t{schedule[1][1]}x3\t{schedule[2][1]}x3\t{schedule[3][1]}x5
Set 3\t{schedule[0][2]}x5\t{schedule[1][2]}x3\t{schedule[2][2]}x1\t{schedule[3][2]}x5
"""
